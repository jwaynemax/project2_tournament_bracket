...
const routes: Routes = [{ path: '', component: HelloComponent}, { path: 'hello', component: HelloComponent}, { path: 'brackets', component: BracketsComponent}, { path: 'registration', component: RegistrationComponent}];
